<?  header('HTTP/1.1 404 Not Foundexit');
...
<p>哎呀！找 不 到 页 面 了 ！</p>
<br>                 
<div class="widget widget_ui_textads"><img src="https://api.suyanw.cn/api/hs" width="30%" height="30%" style="border-radius: 20px;"></div>              
