const ap = new APlayer({
    ...
    audio: [{
     name: "洪荒之力(纯音乐)",
            artist: "进恩哥资源仓库",
            url: "./kodbox/data/files/202404/14_cc3cf09d/小瑞 - PDD洪荒之力 (纯音乐).mp3",
           cover: "https://jinenyy.vip/wallpaper",
            lrc: "",
            theme: "#171513"
        },
            {
            name: "寂寞沙洲冷",
            artist: "周传雄",
            url: "./kodbox/data/files/202404/14_cc3cf09d/周传雄 - 寂寞沙洲冷.mp3",
           cover: "https://jinenyy.vip/wallpaper",
            lrc: "./js/周传雄 – 寂寞沙洲冷.lrc",
            theme: "#171514"
        },
       ]
});
